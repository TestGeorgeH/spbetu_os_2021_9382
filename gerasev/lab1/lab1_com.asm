TESTPC SEGMENT
   ASSUME CS:TESTPC, DS:TESTPC, ES:NOTHING, SS:NOTHING ; Вместо начала CodeSegment
   ORG 100H ; Ставим 0 на 256 т.к. PSP занимает 256
START: JMP BEGIN
; Данные
TYPE_PC db  'Type: PC',0DH,0AH,'$' ; После строки возврат каретки, перенос строки и конец строки
